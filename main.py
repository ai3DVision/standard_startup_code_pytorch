...
parser.add_argument('--dataset', metavar='DATASET', default='TBD',
                    choices=dataset_names,
                    help='dataset type : ' +
                        ' | '.join(dataset_names) +
                        ' (default: TBD)')
parser.add_argument('--arch', '-a', metavar='ARCH', default='TBD',
                    choices=model_names,
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train_loss, train_EPE = train(train_loader, model, criterion, optimizer, epoch)
